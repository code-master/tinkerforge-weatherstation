...
class BrickDC extends Device
{
    ...
    public function callbackWrapperUnderVoltage($data)
    {
        ...
        array_push($result, $this->registeredCallbackUserData[self::CALLBACK_UNDER_VOLTAGE]);
    ...
    public function callbackWrapperEmergencyShutdown($data)
    {
        ...
        array_push($result, $this->registeredCallbackUserData[self::CALLBACK_EMERGENCY_SHUTDOWN]);
    ...
    public function callbackWrapperVelocityReached($data)
    {
        ...
        array_push($result, $this->registeredCallbackUserData[self::CALLBACK_VELOCITY_REACHED]);
    ...
    public function callbackWrapperCurrentVelocity($data)
    {
        ...
        array_push($result, IPConnection::fixUnpackedInt16($payload['velocity']));
        array_push($result, $this->registeredCallbackUserData[self::CALLBACK_CURRENT_VELOCITY]);
