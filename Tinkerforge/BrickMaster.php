...
class BrickMaster extends Device
{
    ...
    public function __construct($uid, $ipcon)
    {
        ...
        $this->responseExpected[self::FUNCTION_SET_ETHERNET_WEBSOCKET_CONFIGURATION] = self::RESPONSE_EXPECTED_FALSE;
        $this->responseExpected[self::FUNCTION_GET_ETHERNET_WEBSOCKET_CONFIGURATION] = self::RESPONSE_EXPECTED_ALWAYS_TRUE;
        $this->responseExpected[self::FUNCTION_SET_ETHERNET_AUTHENTICATION_SECRET] = self::RESPONSE_EXPECTED_FALSE;
        $this->responseExpected[self::FUNCTION_GET_ETHERNET_AUTHENTICATION_SECRET] = self::RESPONSE_EXPECTED_ALWAYS_TRUE;
        $this->responseExpected[self::FUNCTION_SET_WIFI_AUTHENTICATION_SECRET] = self::RESPONSE_EXPECTED_FALSE;
        $this->responseExpected[self::FUNCTION_GET_WIFI_AUTHENTICATION_SECRET] = self::RESPONSE_EXPECTED_ALWAYS_TRUE;
    ...
    public function setEthernetWebsocketConfiguration($sockets, $port)
    {
        ...
        $this->sendRequest(self::FUNCTION_SET_ETHERNET_WEBSOCKET_CONFIGURATION, $payload);
    }
    ...
    public function getEthernetWebsocketConfiguration()
    {
        ...
        $data = $this->sendRequest(self::FUNCTION_GET_ETHERNET_WEBSOCKET_CONFIGURATION, $payload);

        $payload = unpack('C1sockets/v1port', $data);

        $result['sockets'] = $payload['sockets'];
        $result['port'] = $payload['port'];
    ...
    public function setEthernetAuthenticationSecret($secret)
    {
        ...
        $this->sendRequest(self::FUNCTION_SET_ETHERNET_AUTHENTICATION_SECRET, $payload);
    }

    /**
     * Returns the authentication secret as set by BrickMaster::setEthernetAuthenticationSecret().
     * 
     * .. versionadded:: 2.2.0~(Firmware)
     * 
     * 
    ...
    public function getEthernetAuthenticationSecret()
    {
        ...
        $data = $this->sendRequest(self::FUNCTION_GET_ETHERNET_AUTHENTICATION_SECRET, $payload);
    ...
    public function setWifiAuthenticationSecret($secret)
    {
        ...
        $this->sendRequest(self::FUNCTION_SET_WIFI_AUTHENTICATION_SECRET, $payload);
    }

    /**
     * Returns the authentication secret as set by BrickMaster::setWifiAuthenticationSecret().
     * 
     * .. versionadded:: 2.2.0~(Firmware)
     * 
     * 
    ...
    public function getWifiAuthenticationSecret()
    {
        ...
        $data = $this->sendRequest(self::FUNCTION_GET_WIFI_AUTHENTICATION_SECRET, $payload);
    ...
    public function callbackWrapperStackCurrent($data)
    {
        ...
        array_push($result, $this->registeredCallbackUserData[self::CALLBACK_STACK_CURRENT]);
    ...
    public function callbackWrapperStackVoltage($data)
    {
        ...
        array_push($result, $this->registeredCallbackUserData[self::CALLBACK_STACK_VOLTAGE]);
    ...
    public function callbackWrapperUSBVoltage($data)
    {
        ...
        array_push($result, $payload['voltage']);
        array_push($result, $this->registeredCallbackUserData[self::CALLBACK_USB_VOLTAGE]);
    ...
    public function callbackWrapperStackCurrentReached($data)
    {
        ...
        array_push($result, $payload['current']);
        array_push($result, $this->registeredCallbackUserData[self::CALLBACK_STACK_CURRENT_REACHED]);
    ...
    public function callbackWrapperStackVoltageReached($data)
    {
        ...
        array_push($result, $payload['voltage']);
        array_push($result, $this->registeredCallbackUserData[self::CALLBACK_STACK_VOLTAGE_REACHED]);
    ...
    public function callbackWrapperUSBVoltageReached($data)
    {
        ...
        array_push($result, $payload['voltage']);
        array_push($result, $this->registeredCallbackUserData[self::CALLBACK_USB_VOLTAGE_REACHED]);
