...
class BrickletGPS extends Device
{
     ...
     *  "Value", "Description"
     * 
     *  "1", "No Fix, BrickletGPS::getCoordinates() and BrickletGPS::getAltitude() return invalid data"
     *  "2", "2D Fix, only BrickletGPS::getCoordinates() returns valid data"
     *  "3", "3D Fix, BrickletGPS::getCoordinates() and BrickletGPS::getAltitude() return valid data"
     * </code>
     * 
    ...
    public function callbackWrapperCoordinates($data)
    {
        ...
        array_push($result, $this->registeredCallbackUserData[self::CALLBACK_COORDINATES]);
    ...
    public function callbackWrapperStatus($data)
    {
        ...
        array_push($result, $this->registeredCallbackUserData[self::CALLBACK_STATUS]);
    ...
    public function callbackWrapperAltitude($data)
    {
        ...
        array_push($result, $this->registeredCallbackUserData[self::CALLBACK_ALTITUDE]);
    ...
    public function callbackWrapperMotion($data)
    {
        ...
        array_push($result, $this->registeredCallbackUserData[self::CALLBACK_MOTION]);
    ...
    public function callbackWrapperDateTime($data)
    {
        ...
        array_push($result, $this->registeredCallbackUserData[self::CALLBACK_DATE_TIME]);
